...
class test_btc_new_order(unittest.TestCase):
    ...
    def test_buy_btc_usd_with_standard_order_via_empty_array_with_client_id(self):
        ...
        # assert float(response_in_json['executed_amount']) + float(response_in_json['remianing_amount']) == int(5)
    ...
    def test_buy_btc_usd_with_standard_order_with_auntion_only_options_provided(self):
        currency_symbol = "btcusd"
        amount = "5"
        price = "3633.00"
        side = "buy"
